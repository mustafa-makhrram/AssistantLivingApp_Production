...
absoluterow:{
  position:'absolute',top:scale(10),left:scale(10),flexDirection:'row',zIndex:100,alignItems:"center",justifyContent:"space-between",width:devicewidth-scale(20),flex:1
},
name:{
...
bottombox:{
  borderTopLeftRadius:scale(36),borderTopRightRadius:scale(36),backgroundColor:theme.background,zIndex:1000,top:scale(-30),paddingVertical:scale(20),paddingHorizontal:scale(10),height:'100%'
