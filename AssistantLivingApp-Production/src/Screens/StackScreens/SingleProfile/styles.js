...
bottombox:{
  borderTopLeftRadius:scale(36),borderTopRightRadius:scale(36),backgroundColor:theme.background,flex:1,zIndex:1000,top:scale(-30),paddingVertical:scale(20),paddingHorizontal:scale(10)
