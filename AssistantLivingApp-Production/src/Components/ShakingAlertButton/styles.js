...
bottombox:{
  borderTopLeftRadius:scale(36),borderTopRightRadius:scale(36),backgroundColor:'#fff',flex:1,zIndex:1000,top:scale(-30),paddingVertical:scale(20),paddingHorizontal:scale(10)

},
description3: {
  fontSize: scale(15),
  fontFamily:'PoppinsR',color:theme.Tcolor,
...
smalldescription: {
  ...
  btnbox:{
    ...
    padding:scale(10),borderRadius:scale(10),width:scale(100),alignItems:'center',justifyContent:'center'
  },
  btntxt:{
    fontSize:scale(14),fontFamily:'PoppinsM',color:'#fff'
  },
box:{
  backgroundColor:'rgba(255, 182, 193, 0.1)',
  borderRadius:scale(10),padding:scale(10),marginBottom:scale(15),width:'100%',
  alignSelf:'center',elevation:2,shadowColor:'#000',shadowOpacity:0.1,shadowOffset:{width:0,height:2},
  shadowRadius:4,overflow:'hidden',
  minHeight:scale(70),width:'95%'
},
aboutme:{
